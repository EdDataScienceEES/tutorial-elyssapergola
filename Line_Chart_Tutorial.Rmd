...
In order to differentiate what the different lines are showing, we will want to make the lines different colors. In honor of the holiday season, we will be using christmas colors
